...
void main() {
  runApp(MaterialApp(title: " Payment", home: AirtelPayment()));
}

class AirtelPayment extends StatelessWidget {
          ...
          Column(
            ...
            children: [
              Container(
                ...
                child: Text(
                  "Click on Pay for the order below to get a pop message from Airtel. You will get a message when the process is done successfully. ",
                  style:
